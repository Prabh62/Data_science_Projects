...
#define CONFIGURE_ARGS " '--prefix=/home/prabh/Netflix_data/env' '--with-readline' '--with-libraries=/home/prabh/Netflix_data/env/lib' '--with-includes=/home/prabh/Netflix_data/env/include' '--with-openssl' '--with-gssapi' '--with-icu' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-zstd' '--with-uuid=e2fs' '--with-system-tzdata=/home/prabh/Netflix_data/env/share/zoneinfo' '--with-ldap' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/prabh/Netflix_data/env/include -fdebug-prefix-map=/croot/postgresql-split_1741123568549/work=/usr/local/src/conda/postgresql-split-17.4 -fdebug-prefix-map=/home/prabh/Netflix_data/env=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/prabh/Netflix_data/env/lib -Wl,-rpath-link,/home/prabh/Netflix_data/env/lib -L/home/prabh/Netflix_data/env/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/prabh/Netflix_data/env/include' 'CXX=' 'CPP=/croot/postgresql-split_1741123568549/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/home/prabh/Netflix_data/env/lib/pkgconfig'"
