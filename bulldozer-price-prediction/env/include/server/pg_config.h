...
#define CONFIGURE_ARGS " '--prefix=/home/prabh/bulldozer-price-prediction-proj/env' '--with-readline' '--with-libraries=/home/prabh/bulldozer-price-prediction-proj/env/lib' '--with-includes=/home/prabh/bulldozer-price-prediction-proj/env/include' '--with-openssl' '--with-gssapi' '--with-icu' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-zstd' '--with-uuid=e2fs' '--with-system-tzdata=/home/prabh/bulldozer-price-prediction-proj/env/share/zoneinfo' '--with-ldap' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/prabh/bulldozer-price-prediction-proj/env/include -fdebug-prefix-map=/croot/postgresql-split_1733789440288/work=/usr/local/src/conda/postgresql-split-17.2 -fdebug-prefix-map=/home/prabh/bulldozer-price-prediction-proj/env=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/prabh/bulldozer-price-prediction-proj/env/lib -Wl,-rpath-link,/home/prabh/bulldozer-price-prediction-proj/env/lib -L/home/prabh/bulldozer-price-prediction-proj/env/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/prabh/bulldozer-price-prediction-proj/env/include' 'CXX=' 'CPP=/croot/postgresql-split_1733789440288/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/home/prabh/bulldozer-price-prediction-proj/env/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 17.2 on x86_64-conda-linux-gnu, compiled by x86_64-conda-linux-gnu-cc (Anaconda gcc) 11.2.0, 64-bit"
