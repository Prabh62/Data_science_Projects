...
QT.network.enabled_features = ssl dtls ocsp http udpsocket networkproxy socks5 networkinterface networkdiskcache localserver dnslookup gssapi topleveldomain
QT.network.disabled_features = getifaddrs ipv6ifname securetransport schannel sctp brotli sspi
QT_CONFIG += ssl dtls ocsp http udpsocket networkproxy socks5 networkinterface networkdiskcache localserver dnslookup gssapi topleveldomain
QT_MODULES += network
