...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/home/prabh/bulldozer-price-prediction-proj/env/bin/python",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/croot/contourpy_1732540045555/work/.mesonpy-mx3_9rql/lib/contourpy/util",
        source_dir=r"/croot/contourpy_1732540045555/work/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/croot/contourpy_1732540045555/work/.mesonpy-mx3_9rql/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
